...
export default function MoreInfo() {
    return (
        <div className="flex flex-col gap-y-2">
            ...
            <h2>To get the approximate color of the sky as well as the picture of the skyline I&apos;m scraping <StyledLink route={'https://nskyc.com/'} linkType={'external'} routeText={'NSKYC'}/>.</h2>
