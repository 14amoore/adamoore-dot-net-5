    ...
    const clouds = cloudCover(cloudcover_percentage)
      return (
        <div className="flex flex-col gap-y-2">
          ...
          <p>I&apos;m a Software Engineer and Creative Techologist, with an MFA from Parsons School of Design.</p>
          <p>I&apos;m based in Brooklyn where it is currently {current_temp} degrees fahrenheit, with {clouds} skies.</p>
          ...
          <p>This is my portfolio website. It is, and most likely always will be, a work in progress</p>
