...
export default function MoreInfo() {
    return (
        <div className="flex flex-col gap-y-2">
            ...
            <h2>The data from <StyledLink route={'https://www.spotify.com'} linkType={'external'} routeText={'Spotify'}/> is handled in a similar fashion. I use a Lambda function to refresh the token that allows me to access Spotify&apos;s API. The token expires every hour. The token is stored in another S3 bucket. The app uses the token to query Spotify&apos;s API and retrieves my top five artists.</h2>
